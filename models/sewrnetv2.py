...
class SEWiderResNetV2(nn.Module):
    def __init__(self, structure, norm_act=ABN, classes=0, dilation=True, use_se=True,
                 in_size=(64, 64), aspp_out=512, fusion_out=64, aspp_sec=(12, 24, 36)):
        """
        ...
        self.mod1 = nn.Sequential(OrderedDict([
            ("conv1", nn.Conv2d(512, 64, 3, stride=1, padding=1, bias=False))
        ]))
            ...
            for block_id in range(num):
                ...
                blocks.append((
                    ...
                    IdentityResidualBlock(in_channels, channels[mod_id], norm_act=norm_act,
                                          stride=stride, dilation=dil, dropout=drop, use_se=use_se)
                ))
